  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center gap-3">
        <svg
          className={`w-12 h-12 ${darkMode ? 'text-white/60' : 'text-black/40'} group-hover:scale-110 transition-transform`}
          viewBox="0 0 24 24"
          fill="currentColor"
        >
        ...
        <span className={`text-xs font-medium ${darkMode ? 'text-white/40' : 'text-black/40'} group-hover:text-white/60 transition-colors`}>
          View on Instagram
        </span>
      </div>
